        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('tes')}}"><i class="fa fa-dashboard fa-fw"></i>Dashboard</a>
                    </li>

                    <li class="selected">
                        <a href="{{route('user')}}"><i class="fa fa-user fa-fw"></i>User</a>
                    </li>

                    <li>
                        <a href="{{route('berita')}}"><i class="fa fa-flask fa-fw"></i>Berita</a>
                    </li>
                    <li>
                        <a href="{{route('kontak')}}"><i class="fa fa-flask fa-fw"></i>Kontak</a>
                    </li>
                    <li>
